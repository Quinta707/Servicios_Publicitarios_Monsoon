...
namespace ServiciosPublicitarios.DataAccess.Repository
{
    public class ScriptsDataBase
    {
        ...
        public static string UDP_tbInsumos_DDL = "pbli.UDP_tbInsumos_Cate_DDL";
        #endregion
        ...
        public static string UDP_InsumosPorServicio_Insertar = "pbli.UDP_tbInsumosPorServicio_Insert";
        public static string UDP_InsumosPorServicio_Eliminar = "pbli.UDP_tbInsumosPorServicio_Delete";
        #endregion
